                    ...
                    <form action="users.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="role" name="role" required>
                                ...
                                <option value="program head" <?php echo $user['role'] == 'program head' ? 'selected' : ''; ?>>Program Head</option>
...
function deleteConfirmationModal($id, $type) {
    ?>
    <!-- Delete Confirmation Modal -->
    <div class="modal fade" id="deleteModal<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel<?php echo $id; ?>" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
function editDepartmentModal($department) {
    ...
    <div class="modal fade" id="editDepartmentModal<?php echo $department['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editDepartmentModalLabel<?php echo $department['id']; ?>" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="departments.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name<?php echo $department['id']; ?>" name="name" value="<?php echo htmlspecialchars($department['name']); ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="description<?php echo $department['id']; ?>">Description</label>
                            <textarea class="form-control" id="description<?php echo $department['id']; ?>" name="description" rows="3"><?php echo htmlspecialchars($department['description']); ?></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                ...
                <form action="ajax/update_task.php" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title<?php echo $task['id']; ?>" name="title" value="<?php echo htmlspecialchars($task['title'] ?? ''); ?>" required <?php echo $is_staff_editing ? 'readonly' : ''; ?>>
                        </div>
                        <div class="form-group">
                            <label for="description<?php echo $task['id']; ?>">Description</label>
                            <textarea class="form-control" id="description<?php echo $task['id']; ?>" name="description" rows="3" <?php echo $is_staff_editing ? 'readonly' : ''; ?>><?php echo htmlspecialchars($task['description'] ?? ''); ?></textarea>
                        </div>
                        <?php if (!$is_staff_editing): ?>
                        <div class="form-group">
                            <label for="department_id<?php echo $task['id']; ?>">Department</label>
                            <select class="form-control" id="department_id<?php echo $task['id']; ?>" name="department_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="priority<?php echo $task['id']; ?>" name="priority" required <?php echo $is_staff_editing ? 'disabled' : ''; ?>>
                                <?php if ($is_staff_editing): ?>
                                    <option value="<?php echo $task['priority']; ?>" selected><?php echo ucfirst($task['priority']); ?></option>
                                <?php else: ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="due_date<?php echo $task['id']; ?>" name="due_date" value="<?php echo $task['due_date']; ?>" required <?php echo $is_staff_editing ? 'readonly' : ''; ?>>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
function viewTaskModal($task) {
    ...
    ?>
    <!-- View Task Modal -->
    <div class="modal fade" id="viewTaskModal<?php echo $task['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="viewTaskModalLabel<?php echo $task['id']; ?>" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Title:</strong> <?php echo htmlspecialchars($task['request_title'] ?? $task['title'] ?? 'Untitled Task'); ?></p>
                            <p><strong>Description:</strong> <?php echo nl2br(htmlspecialchars($task['description'] ?? '')); ?></p>
                            <p><strong>Department:</strong> <?php echo htmlspecialchars($task['department_name'] ?? 'No Department'); ?></p>
                            ...
                            <p><strong>Priority:</strong> <span class="badge badge-<?php echo $priorityClass; ?>"><?php echo ucfirst($priority); ?></span></p>
                            ...
                            <?php if (isset($task['category'])): ?>
                                <?php if ($task['category'] === 'printing'): ?>
                                    ...
                                    <p><strong>Number of Copies:</strong> <?php echo htmlspecialchars($task['num_copies'] ?? 'N/A'); ?></p>
                                    <p><strong>Paper Size:</strong> <?php echo htmlspecialchars($task['paper_size'] ?? 'N/A'); ?></p>
                                    <p><strong>Paper Type:</strong> <?php echo htmlspecialchars($task['paper_type'] ?? 'N/A'); ?></p>
                                <?php elseif ($task['category'] === 'repairs'): ?>
                                    <h6>Repair Details</h6>
                                    <p><strong>Equipment Name:</strong> <?php echo htmlspecialchars($task['equipment_name'] ?? 'N/A'); ?></p>
                                    <p><strong>Problem Description:</strong> <?php echo nl2br(htmlspecialchars($task['problem_description'] ?? 'N/A')); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="col-md-6">
                            ...
                            ?>
                            <p><strong>Program Head Approval:</strong> <span class="badge badge-<?php echo $ph_class; ?>"><?php echo ucfirst($ph_approval); ?></span></p>
                            ...
                            ?>
                            <p><strong>ADAA Approval:</strong> <span class="badge badge-<?php echo $adaa_class; ?>"><?php echo ucfirst($adaa_approval); ?></span></p>
                            
                            <p><strong>Created:</strong> <?php echo isset($task['created_at']) ? date('M d, Y H:i', strtotime($task['created_at'])) : 'Unknown'; ?></p>
                            <p><strong>Last Updated:</strong> <?php echo isset($task['updated_at']) ? date('M d, Y H:i', strtotime($task['updated_at'])) : 'Unknown'; ?></p>
                            <?php if(isset($task['completed_at']) && $task['completed_at']): ?>
                                <p><strong>Completed On:</strong> <?php echo date('M d, Y H:i', strtotime($task['completed_at'])); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <?php if($task['status'] == 'pending_confirmation' && isset($task['requester_id']) && ($task['requester_id'] == $_SESSION['user_id'] || $_SESSION['role'] === 'admin')): ?>
                        <button type="button" class="btn btn-success confirm-task" 
                                data-task-id="<?php echo $task['id']; ?>" 
                                data-status="completed">
                            <i class="fas fa-check"></i> Confirm Completion
                        </button>
                        <button type="button" class="btn btn-danger confirm-task" 
                                data-task-id="<?php echo $task['id']; ?>" 
...
function requestTaskModal() {
    ...
    ?>
    <!-- Request Task Modal -->
    <div class="modal fade" id="requestTaskModal" tabindex="-1" role="dialog" aria-labelledby="requestTaskModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="num_copies" name="num_copies" min="1">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file" id="template" name="template" accept=".doc,.docx,.pdf,.ppt,.pptx">
                                            <small class="form-text text-muted">Accepted formats: DOC, DOCX, PDF, PPT, PPTX</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function viewTaskRequestModal($request) {
    ...
    ?>
    <div class="modal fade" id="viewTaskRequestModal<?php echo $requestId; ?>" tabindex="-1" role="dialog" aria-labelledby="viewTaskRequestModalLabel<?php echo $requestId; ?>" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewTaskRequestModalLabel<?php echo $requestId; ?>">Task Request Details <?php echo '<span class="badge badge-info">' . ($request['effective_status'] ?? ucfirst($request['status'])) . '</span>'; ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Title:</strong> <?php echo htmlspecialchars($request['request_title'] ?? $request['title'] ?? 'Untitled Request'); ?></p>
                            <p><strong>Description:</strong> <?php echo nl2br(htmlspecialchars($request['description'] ?? '')); ?></p>
                            <p><strong>Department:</strong> <?php echo htmlspecialchars($request['department_name'] ?? 'No Department'); ?></p>
                        ...
                        <div class="col-md-6">
                            ...
                            <p><strong>Request Date:</strong> <?php echo date('M d, Y h:i A', strtotime($request['created_at'])); ?></p>
                            <p><strong>Last Updated:</strong> <?php echo date('M d, Y h:i A', strtotime($request['updated_at'])); ?></p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="$('#viewTaskRequestModal<?php echo $requestId; ?>').modal('hide'); setTimeout(function() { $('#assignTaskModal<?php echo $requestId; ?>').modal('show'); }, 500);">
    ...
    <div class="modal fade" id="assignTaskModal<?php echo $requestId; ?>" tabindex="-1" role="dialog" aria-labelledby="assignTaskModalLabel<?php echo $requestId; ?>" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="assignTaskForm<?php echo $requestId; ?>" method="post" action="task_requests.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($requesterName); ?>" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="due_date<?php echo $requestId; ?>" name="due_date" value="<?php echo htmlspecialchars($request['due_date'] ?? ''); ?>" readonly>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="submit" form="assignTaskForm<?php echo $requestId; ?>" class="btn btn-primary">Assign</button>
                </div>
            </div>
        </div>
    </div>
