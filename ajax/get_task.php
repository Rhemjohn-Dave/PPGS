                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo nl2br(htmlspecialchars($taskRequest['problem_description'] ?? 'Not specified')); ?></p>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo htmlspecialchars(ucfirst($taskRequest['category'] ?? 'Not specified')); ?></p>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Program Head Approval:</strong><br>
                            <span class="badge <?php echo getStatusBadgeClass($taskRequest['program_head_approval'] ?? 'pending'); ?>">
                                <?php echo formatStatus($taskRequest['program_head_approval'] ?? 'pending'); ?>
                            </span></p>
                            
                            <p><strong>ADAA Approval:</strong><br>
                            <span class="badge <?php echo getStatusBadgeClass($taskRequest['adaa_approval'] ?? 'pending'); ?>">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item">
                            <div class="d-flex w-100 justify-content-between">
                                <h6 class="mb-1"><?php echo htmlspecialchars($comment['full_name'] ?? $comment['username']); ?></h6>
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item">
                            ...
                            <p class="mb-1">
                                Uploaded by: <?php echo htmlspecialchars($attachment['full_name'] ?? $attachment['username']); ?>
                                <a href="<?php echo htmlspecialchars($attachment['file_path']); ?>" class="btn btn-sm btn-primary ml-2" target="_blank">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <p><strong>Department:</strong><br> <?php echo htmlspecialchars($taskRequest['department_name']); ?></p>
                    ...
                    <p><strong>Created:</strong><br> <?php echo date('M d, Y g:i A', strtotime($task['created_at'])); ?></p>
                    
                    <p><strong>Last Updated:</strong><br> <?php echo isset($task['updated_at']) ? date('M d, Y g:i A', strtotime($task['updated_at'])) : 'Never'; ?></p>

                    <?php if ($_SESSION['role'] === 'staff' && $task['assigned_to'] == $_SESSION['user_id']): ?>
                        <?php if ($task['status'] === 'pending'): ?>
                            <div class="mt-3">
                                <button type="button" class="btn btn-primary btn-block" onclick="updateTaskStatus(<?php echo $task['id']; ?>, 'in_progress')">
                                    <i class="fas fa-play"></i> Start Task
                                </button>
                            </div>
                        <?php elseif ($task['status'] === 'in_progress'): ?>
                            <div class="mt-3">
                                <button type="button" class="btn btn-success btn-block" onclick="updateTaskStatus(<?php echo $task['id']; ?>, 'pending_confirmation')">
            ...
            <?php if ($_SESSION['role'] === 'admin' || (isset($taskRequest['requester_id']) && $taskRequest['requester_id'] == $_SESSION['user_id'])): ?>
                <?php if ($task['status'] === 'pending_confirmation'): ?>
                    <div class="card mb-4">
                        <div class="card-body">
                            <button type="button" class="btn btn-success btn-block" onclick="updateTaskStatus(<?php echo $task['id']; ?>, 'completed')">
